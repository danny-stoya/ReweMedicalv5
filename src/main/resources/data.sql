# insert into diagnoses (code, description) values ('W880', 'Exposure to X-rays');
# insert into diagnoses (code, description) values ('T83418A', 'Breakdown of prosth dev/implnt/grft of genitl trct, init');
# insert into diagnoses (code, description) values ('V263XXA', 'Prsn brd/alit mtrcy injured in clsn w nonmtr vehicle, init');
# insert into diagnoses (code, description) values ('S7619', 'Oth injury of quadriceps muscle, fascia and tendon');
# insert into diagnoses (code, description) values ('T23662D', 'Corrosion of second degree back of left hand, subs encntr');
# insert into diagnoses (code, description) values ('S42326D', 'Nondisp transverse fx shaft of humer, unsp arm, 7thD');
# insert into diagnoses (code, description) values ('S85819A', 'Lacerat blood vessels at lower leg level, unsp leg, init');
# insert into diagnoses (code, description) values ('S70329A', 'Blister (nonthermal), unspecified thigh, initial encounter');
...
#
# insert into patients (has_insurance, name, uid, gp_id) values (true, 'Starlene', '#8f4', 1);
# insert into patients (has_insurance, name, uid, gp_id) values (true, 'Kyrstin', '#9cb', 2);
# insert into patients (has_insurance, name, uid, gp_id) values (false, 'Wylma', '#348', null);
